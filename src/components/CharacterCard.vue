<template>
  <sui-card class="marginAuto">
    ...
    <sui-card-content>
      ...
      <sui-card-meta>
        <div class="ui grey label" v-if="character.comics.available">{{character.comics.available}} commics</div>
        <div class="ui grey label" v-if="character.series.available">{{character.series.available}} series</div>
        <div class="ui grey label" v-if="character.stories.available">{{character.stories.available}} stories</div>
        </sui-card-meta>
      <sui-card-description>{{ character.description }}</sui-card-description>
    </sui-card-content>
    <sui-button attached="bottom" :positive="character.selected" v-on:click="addToTeam(character)">
